...
**Method:** llamaparse
**Characters extracted:** 6,267

Sheet 1/2

# ACCIDENT STATEMENT

* **1. Date of accident**: 09.10.2024
* **Time**: 12h41
* **2. Locality**:
    * **Country**: CH
    * **Place**: Limmatstrasse
...
* **A**
    ...
    * 4 [x] emerging from a car park, from private ground, from a track
    ...
    * **state number of boxes marked with a cross**: 1
...
* **B**
    ...
    * 5 [x] entering a car park, private ground, a track
    * 6 [ ] entering a roundabout
    * 7 [ ] circulating a roundabout
    * 8 [ ] striking the rear of the other vehicle while going in the same direction and in the same lane
    * 9 [x] going in the same direction but in a different lane
    * 10 [ ] changing lanes
    * 11 [ ] overtaking
    * 12 [ ] turning to the right
    * 13 [ ] turning to the left
    ...
    * 16 [ ] coming from the right (at road junctions)
    * 17 [ ] had not observed a right of way sign or a red light
    * **state number of boxes marked with a cross**: 2
...
![Diagram of vehicle A showing impact point](page_1_layout_ocr_vjpo_60_174_2722_3834.png)

**10. Indicate the point of initial impact to vehicle B by an arrow →**
![Diagram of vehicle B showing impact point](page_1_layout_ocr_vjpo_60_174_2722_3834.png)
...
**A**
![Signature of driver A](page_1_image_2_v2.jpg)

**B**
![Signature of driver B](page_1_image_1_v2.jpg)
